<?php
  ...
  if($_SESSION['user_role'] != "garçom"){
    echo ("<script>window.alert('Somente garçom!'); window.location.href='index.php';</script>");
    exit();
  }
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <hr>
          <p>Gerenciamento de novo pedido.</p>
            ...
            <div class="col-lg-6">
              <div class="card mb-3">
                ...
                <div id="qtypanel" hidden="">
        					Quantidade : <input id="qty" required="required" type="number" min="1" max="50" name="qty" value="1" />
        					<button class="btn btn-info" onclick = "insertItem()">Feito</button>
        					<br><br>
				</div>
