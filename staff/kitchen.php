<?php
  ...
  if($_SESSION['user_role'] != "chef") {
    echo ("<script>window.alert('Somente Chefs!'); window.location.href='index.php';</script>");
    exit();
  }
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Content -->
          <h1>Gerenciamento da cozinha</h1>
          <hr>
          <p>Gerenciar pedidos enviados.</p>

          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-utensils"></i>
              Lista atual de pedidos.</div>
            <div class="card-body">
