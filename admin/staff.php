...
<html>
  ...
  <head>
    ...
    <title>Gerenciamento da equipe - Admin</title>
                ...
                <div class="card-body">
                  <form action="addstaff.php" method="POST" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                    <div class="input-group">
                      ...
                      <input type="text" required="required" name="staffname" class="form-control" placeholder="Add novo usuário" aria-label="Add" aria-describedby="basic-addon2">
