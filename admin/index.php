          ...
          <div class="row">
            <div class="col-lg-8">
              <div class="card mb-3">
                ...
                <div class="card-footer small text-muted"><i>Refresh cada 5segundo(s)</i></div>
              </div>
            </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Fazendo mesmo o Logout?</h5>
