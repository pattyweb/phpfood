    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <hr>
          <p>Todos os dados das vendas são visualizados aqui.</p>

          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-chart-area"></i>
              Estatísticas dos ganhos das vendas
            </div>
            <div class="card-body">
              <table class="table table-bordered" width="100%" cellspacing="0">
                <tbody>
                  <tr>
                    <td>Hoje</td>
                    <td>R$ <?php echo getSalesGrandTotal("DAY"); ?></td>
                  </tr>
                  <tr>
                    <td>Essa Semana</td>
                    <td>R$ <?php echo getSalesGrandTotal("WEEK"); ?></td>
                  </tr>
                  <tr>
                    <td>Este Mês</td>
                    <td>R$ <?php echo getSalesGrandTotal("MONTH"); ?></td>
                  </tr>
                  <tr class="table-info">
                    <td><b>Total</b></td>
                    <td><b>R$ <?php echo getSalesGrandTotal("ALLTIME"); ?></b></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-chart-area"></i>
              Listas dos pedidos vendidos</div>
            <div class="card-body">
                    ...
                    <tbody id="tblBodyCurrentOrder">
                      ...
                      if ($orderResult = $sqlconnection->query($displayOrderQuery)) {
                        ...
                        if ($orderResult->num_rows == 0) {
                          ...
                          echo "<tr><td class='text-center' colspan='7' >Não há pedido a ser mostrado agora. </td></tr>";
                        }
